module Contexts
  module InstructorContexts
    def create_instructors
      ...
      @markk = FactoryBot.create(:user, username:"mark" , role:"admin" , email: "yabdelaal@hotmail.com" , phone:"9999999999" ,  password:"12345" , password_confirmation:"12345")
      @alexx = FactoryBot.create(:user, username:"alex" , role:"admin" , email: "ndahneem@hotmail.com" , phone:"9999999999" ,  password:"12345" , password_confirmation:"12345")
      ...
      @rachel = FactoryBot.create(:instructor, first_name: "Rachel", last_name: "Ferraco" ,  user_id: @alexx.id, bio: nil, active: false)
    end
